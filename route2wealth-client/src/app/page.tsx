            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between h-16">
                ...
                <div className="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                  <a href="#home" className="px-3 py-2 text-sm font-medium text-emerald-800 hover:text-emerald-500">Home</a>
                  ...
                  <a href="#education" className="px-3 py-2 text-sm font-medium text-emerald-800 hover:text-emerald-500">Learn</a>
